...
/* tslint:disable */
/* eslint-disable */
import type { AnnotationResultExpanded } from './AnnotationResultExpanded';
import type { ApplicationTestCaseOutputWithTraces } from './ApplicationTestCaseOutputWithTraces';
...
import type { MetricValueEntity } from './MetricValueEntity';
import type { ResultSchemaGeneration } from './ResultSchemaGeneration';
import type { TaskWithAssignee } from './TaskWithAssignee';
import type { UserV2Details } from './UserV2Details';
export type GenerationTestCaseResultResponseWithViews = {
    application_test_case_output?: ApplicationTestCaseOutputWithTraces;
    test_case_version?: egp_api_backend__server__api__models__eval_models_no_gen__TestCaseVersionResponse;
    task?: TaskWithAssignee;
    metrics?: Record<string, number>;
    custom_metrics?: Array<MetricValueEntity>;
    audit_tasks?: Array<TaskWithAssignee>;
    annotation_results?: Array<AnnotationResultExpanded>;
    /**
