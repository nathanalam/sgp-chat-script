...
import type { ApplicationVariantReportAsyncJob } from './ApplicationVariantReportAsyncJob';
import type { EvaluationDatasetReportGeneration } from './EvaluationDatasetReportGeneration';
export type ApplicationVariantReportWithScoresResponseWithViews = {
    async_jobs?: Array<ApplicationVariantReportAsyncJob>;
