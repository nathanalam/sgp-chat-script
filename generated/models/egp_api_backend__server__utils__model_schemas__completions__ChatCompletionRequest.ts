 ...
 */
export type egp_api_backend__server__utils__model_schemas__completions__ChatCompletionRequest = {
     ...
     */
    reasoning_effort?: egp_api_backend__server__utils__model_schemas__completions__ChatCompletionRequest.reasoning_effort;
    /**
     * Chat history entries with roles and messages. If there's no history, pass an empty list.
     */
    chat_history: Array<ChatMessageV2>;
    /**
     * New user prompt. This will be sent to the model with a user role.
     */
    prompt: string;
};
export namespace egp_api_backend__server__utils__model_schemas__completions__ChatCompletionRequest {
    /**
     * The reasoning effort to use for the completion. Currently only supported for openai models.
     */
