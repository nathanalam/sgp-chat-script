...
export type AutoGeneratedDraftTestCaseResponse = {
    /**
     * The ID of the associated evaluation dataset.
     */
    evaluation_dataset_id: string;
    schema_type?: AutoGeneratedDraftTestCaseResponse.schema_type;
    /**
...
export namespace AutoGeneratedDraftTestCaseResponse {
