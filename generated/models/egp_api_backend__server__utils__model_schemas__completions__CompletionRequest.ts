...
export type egp_api_backend__server__utils__model_schemas__completions__CompletionRequest = {
     ...
     */
    reasoning_effort?: egp_api_backend__server__utils__model_schemas__completions__CompletionRequest.reasoning_effort;
    prompts: Array<string>;
};
export namespace egp_api_backend__server__utils__model_schemas__completions__CompletionRequest {
    /**
     * The reasoning effort to use for the completion. Currently only supported for openai models.
     */
