...
export type PaginatedApplicationVariantResponse = {
    /**
     * The data returned for the current page.
     */
    items: Array<egp_api_backend__server__api__models__application_models_no_gen__ApplicationVariantResponse>;
    /**
